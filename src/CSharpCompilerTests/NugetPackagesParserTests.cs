...
public class NugetPackagesParserTests
{
    ...
    [TestCase("Package: NUnit 1.0.0-x.7.z.92", true, "NUnit", "1.0.0-x.7.z.92")]
    [TestCase("Package: NUnit 1.0.0+x.7.z.92", true, "NUnit", "1.0.0+x.7.z.92")]
    [TestCase("Package: NUnit 1.0.0-beta+exp.sha.5114f85", true, "NUnit", "1.0.0-beta+exp.sha.5114f85")]
    [TestCase("Package: NUnit 1.0.0+beta+exp.sha.5114f85", false, null, null)]
    [TestCase("Package: NUnit-valid 1.0.0-beta+exp.sha.5114f85", true, "NUnit-valid", "1.0.0-beta+exp.sha.5114f85")]
